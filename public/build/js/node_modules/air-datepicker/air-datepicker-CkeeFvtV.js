import { __module as X } from "../../_virtual/air-datepicker-Cr2SmWQI.js";
var De = X.exports, he;
function be() {
  return he ? X.exports : (he = 1, (function(oe, ye) {
    (function(q, W) {
      oe.exports = W();
    })(De, (function() {
      return (function() {
        var q = { d: function(h, e) {
          for (var i in e) q.o(e, i) && !q.o(h, i) && Object.defineProperty(h, i, { enumerable: !0, get: e[i] });
        }, o: function(h, e) {
          return Object.prototype.hasOwnProperty.call(h, e);
        } }, W = {};
        q.d(W, { default: function() {
          return F;
        } });
        ...
        function k() {
          ...
          return e && a.classList.add(...e.split(" ")), t && (a.id = t), i && (a.innerHTML = i), n && Q(a, n), a;
        }
        function Q(h, e) {
        ...
        function g(h) {
          let e = h.getHours(), { hours: i, dayPeriod: t } = ae(e);
        ...
        function S(h, e, i) {
          let t = z(h, !1).getTime(), n = z(e, !1).getTime();
          return i ? t >= n : t > n;
        }
        function j(h, e) {
          return !S(h, e, !0);
        ...
        class le {
          constructor() {
            ...
            })), H(this, "onChangeSelectedDate", (() => {
              this.isDisabled || (this._handleSelectedStatus(), this.opts.range && this._handleRangeStatus());
            })), H(this, "onChangeFocusDate", ((s) => {
            ...
            })), H(this, "render", (() => (this.$cell.innerHTML = this._getHtml(), this._handleClasses(), this.$cell))), this.type = e, this.singleType = this.type.slice(0, -1), this.date = i, this.dp = t, this.opts = n, this.body = a, this.customData = !1, this.init();
          }
          init() {
            var e, i;
          ...
          _createElement() {
            ...
            this.$cell = k({ attrs: { "data-year": i, "data-month": t, "data-date": a, "data-iso-date": `${i}-${n}-${s}`, ...r } }), this.$cell.adpCell = this;
          }
          _getClassName() {
            var e;
        ...
        let de = { [l.days]: `<div class="air-datepicker-body--day-names"></div><div class="air-datepicker-body--cells -${l.days}-"></div>`, [l.months]: `<div class="air-datepicker-body--cells -${l.months}-"></div>`, [l.years]: `<div class="air-datepicker-body--cells -${l.years}-"></div>` };
        ...
        class V {
          ...
          _buildBaseHtml() {
            this.$el = k({ className: `air-datepicker-body -${this.type}-`, innerHtml: de[this.type] }), this.$names = y(".air-datepicker-body--day-names", this.$el), this.$cells = y(".air-datepicker-body--cells", this.$el);
          }
          _getDayNamesHtml() {
          ...
          _generateCell(e) {
            ...
            return new le({ type: i, dp: t, opts: n, date: e, body: this });
          }
          _generateCells() {
          ...
          static getDaysDates(e, i) {
            let { viewDate: t, opts: { fixedHeight: n }, locale: { firstDay: a } } = e, s = se(t), { year: r, month: o } = g(t), d = new Date(r, o, 1), c = new Date(r, o, s), u = d.getDay() - a, p = 6 - c.getDay() + a;
            u = u < 0 ? u + 7 : u, p = p > 6 ? p - 7 : p;
            let v = (function(I, te) {
              let { year: J, month: ve, date: fe } = g(I);
              return new Date(J, ve, fe - te);
            })(d, u), w = s + u + p, D = v.getDate(), { year: M, month: Y } = g(v), O = 0;
            n && (w = 42);
            const N = [];
            for (; O < w; ) {
              let I = new Date(M, Y, D + O);
              i && i(I), N.push(I), O++;
            }
            return N;
          }
        ...
        class ue {
          constructor(e) {
            ...
            E(this, "onClickNav", ((n) => {
              ...
              this.dp[s]();
            })), E(this, "onChangeViewDate", (() => {
              this.render(), this._resetNavStatus(), this.handleNavStatus();
            })), E(this, "onChangeCurrentView", (() => {
              this.render(), this._resetNavStatus(), this.handleNavStatus();
            })), E(this, "onClickNavTitle", (() => {
          ...
          _createElement() {
            this.$el = k({ tagName: "nav", className: "air-datepicker-nav" });
          }
          _getTitle() {
        ...
        var ne = { today: { content: (h) => h.locale.today, onClick: (h) => h.setViewDate(/* @__PURE__ */ new Date()) }, clear: { content: (h) => h.locale.clear, onClick: (h) => h.clear() } };
        class ce {
          constructor(e) {
            let { dp: i, opts: t } = e;
            this.dp = i, this.opts = t, this.init();
          ...
          createElement() {
            this.$el = k({ className: "air-datepicker-buttons" });
          }
          destroy() {
          ...
          createButton(e) {
            ...
            return k({ tagName: n, innerHtml: `<span tabindex='-1'>${typeof i == "function" ? i(this.dp) : i}</span>`, className: _("air-datepicker-button", t), attrs: a });
          }
          render() {
        ...
        class pe {
          constructor() {
            ...
            t && (t.match(Z("h")) || t.match(Z("hh"))) && (this.ampm = !0), this.init();
          }
          init() {
          ...
          createElement() {
            this.$el = k({ className: _("air-datepicker-time", { "-am-pm-": this.dp.ampm }) });
          }
          destroy() {
        ...
        class me {
          constructor(e) {
            let { dp: i, opts: t } = e;
            A(this, "pressedKeys", /* @__PURE__ */ new Set()), A(this, "hotKeys", /* @__PURE__ */ new Map([[[["Control", "ArrowRight"], ["Control", "ArrowUp"]], (n) => n.month++], [[["Control", "ArrowLeft"], ["Control", "ArrowDown"]], (n) => n.month--], [[["Shift", "ArrowRight"], ["Shift", "ArrowUp"]], (n) => n.year++], [[["Shift", "ArrowLeft"], ["Shift", "ArrowDown"]], (n) => n.year--], [[["Alt", "ArrowRight"], ["Alt", "ArrowUp"]], (n) => n.year += 10], [[["Alt", "ArrowLeft"], ["Alt", "ArrowDown"]], (n) => n.year -= 10], [["Control", "Shift", "ArrowUp"], (n, a) => a.up()]])), A(this, "handleHotKey", ((n) => {
              let a = this.hotKeys.get(n), s = g(this.getInitialFocusDate());
              a(s, this.dp);
              let { year: r, month: o, date: d } = s, c = se(new Date(r, o));
              c < d && (d = c);
              ...
              return n;
            })), A(this, "isArrow", ((n) => n >= 37 && n <= 40)), A(this, "onKeyDown", ((n) => {
        ...
        class F {
          static buildGlobalContainer(e) {
            ee = !0, R = k({ className: e, id: e }), y("body").appendChild(R);
          }
          constructor(e, i) {
            var t = this;
            if (m(this, "viewIndexes", [l.days, l.months, l.years]), m(this, "next", (() => {
              ...
              let o, d, { isMobile: c } = t.opts, u = t.$el.getBoundingClientRect(), p = t.$el.getBoundingClientRect(), v = t.$datepicker.offsetParent, w = t.$el.offsetParent, D = t.$datepicker.getBoundingClientRect(), M = s.split(" "), Y = window.scrollY, O = window.scrollX, N = t.opts.offset, I = M[0], te = M[1];
              if (c) t.$datepicker.style.cssText = "left: 50%; top: 50%";
              else {
                if (v === w && v !== document.body && (p = { top: t.$el.offsetTop, left: t.$el.offsetLeft, width: u.width, height: t.$el.offsetHeight }, Y = 0, O = 0), v !== w && v !== document.body) {
                  let J = v.getBoundingClientRect();
                  p = { top: u.top - J.top, left: u.left - J.left, width: u.width, height: u.height }, Y = 0, O = 0;
                }
                switch (I) {
                  case "top":
                    o = p.top - D.height - N;
                ...
                t.$datepicker.style.cssText = `left: ${d + O}px; top: ${o + Y}px`;
              }
              ...
              if (!((s = $(s)) instanceof Date) || f(s, this.viewDate)) return;
              let r = this.viewDate;
              this.viewDate = s;
              ...
              let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
              (!s || (s = $(s)) instanceof Date) && (t.focusDate = s, t.trigger(l.eventChangeFocusDate, s, r));
              ...
              let s = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, o = G({}, t.opts), { silent: d } = r;
              G(t.opts, s);
            ...
            this.$datepicker = k({ className: "air-datepicker" }), this.opts = G({}, ie, i), this.$customContainer = !!this.opts.container && y(this.opts.container), this.$altField = y(this.opts.altField || !1);
          ...
          init() {
            ...
            (!ee || ee && R && !o.contains(R)) && !t && this.elIsInput && !this.$customContainer && F.buildGlobalContainer(F.defaultGlobalContainerId), !n || T || i || this._createMobileOverlay(), this._handleLocale(), this._bindSubEvents(), this._createMinMaxDates(), this._limitViewDateByMaxMinDates(), this.elIsInput && (t || this._bindEvents(), s && !r && (this.keyboardNav = new me({ dp: this, opts: e }))), a && this.selectDate(a, { silent: !0 }), this.opts.visible && !i && this.show(), n && !i && this.$el.setAttribute("readonly", !0), i && this._createComponents();
          }
          _createMobileOverlay() {
            T = k({ className: "air-datepicker-overlay" }), R.appendChild(T);
          }
          _createComponents() {
            let { opts: e, treatAsInline: i, opts: { inline: t, buttons: n, timepicker: a, position: s, classes: r, onlyTimepicker: o, isMobile: d } } = this;
            this._buildBaseHtml(), this.elIsInput && (t || this._setPositionClasses(s)), !t && this.elIsInput || this.$datepicker.classList.add("-inline-"), r && this.$datepicker.classList.add(...r.split(" ")), o && this.$datepicker.classList.add("-only-timepicker-"), d && !i && this._addMobileAttributes(), this.views[this.currentView] = new V({ dp: this, type: this.currentView, opts: e }), this.nav = new ue({ dp: this, opts: e }), a && this._addTimepicker(), n && this._addButtons(), this.$content.appendChild(this.views[this.currentView].$el), this.$nav.appendChild(this.nav.$el);
          }
          _destroyComponents() {
          ...
          _createMinMaxDates() {
            ...
            this.minDate = !!e && $(e), this.maxDate = !!i && $(i);
          }
          _addTimepicker() {
            this.$timepicker = k({ className: "air-datepicker--time" }), this.$datepicker.appendChild(this.$timepicker), this.timepicker = new pe({ dp: this, opts: this.opts }), this.$timepicker.appendChild(this.timepicker.$el);
          }
          _addButtons() {
            this.$buttons = k({ className: "air-datepicker--buttons" }), this.$datepicker.appendChild(this.$buttons), this.buttons = new ce({ dp: this, opts: this.opts }), this.$buttons.appendChild(this.buttons.$el);
          }
          _bindSubEvents() {
          ...
          formatDate() {
            ...
            for (let [c, u] of Object.entries(d)) t = o(t, Z(c), u);
            return t;
          }
          down(e) {
          ...
          unselectDate(e) {
            ...
            if ((e = $(e)) instanceof Date) return i.some(((n, a) => {
          ...
          _triggerOnSelect() {
            ...
            t.length && (e = t.map(z), i = d ? s ? n.dateFormat(e) : e.map(((c) => n.dateFormat(c))) : e.map(((c) => this.formatDate(c, n.dateFormat)))), a({ date: o ? e : e[0], formattedDate: o ? i : i[0], datepicker: this });
          }
          _handleAlreadySelectedDates(e, i) {
            let { selectedDates: t, rangeDateFrom: n, rangeDateTo: a } = this, { range: s, toggleSelected: r } = this.opts, o = t.length, d = typeof r == "function" ? r({ datepicker: this, date: i }) : r, c = !!(s && o === 1 && e), u = c ? z(i) : i;
            s && !d && (o !== 2 && this.selectDate(u), o === 2 && f(n, a)) || (d ? this.unselectDate(u) : this._updateLastSelectedDate(c ? u : e));
          }
          _handleUpDownActions(e, i) {
            if (!((e = $(e || this.focusDate || this.viewDate)) instanceof Date)) return;
        ...
        var re;
        return m(F, "defaults", ie), m(F, "version", "3.6.0"), m(F, "defaultGlobalContainerId", "air-datepicker-global-container"), re = F.prototype, Object.assign(re, ge), W.default;
      })();
    }));
  })(X), X.exports);
}
